...
export type GameId = 'hangman' | 'memory' | 'aventura' | 'aventura-espacio' | 'aventura-magica' | 'casa-encantada' | 'mastermind' | 'wordle' | 'mates-rapidas' | 'laberinto' | 'anagramas' | 'blackjack' | 'pong' | 'batalla-naval' | 'penaltis' | 'tres-en-raya' | 'gorillas' | 'misterio' | 'secuencias' | 'conecta4' | 'generala' | '2048' | 'bingo' | 'space-invaders' | 'tetris' | 'frogger' | 'pacman' | 'asteroids' | 'buscaminas' | 'sokoban'
